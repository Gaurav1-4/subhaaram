...
<div class="custom-hero-wrapper">
    ...
    <nav class="custom-nav">
        ...
        <div class="custom-nav-socials">
            <a href="https://www.instagram.com/subhaaram_invitations/"><svg viewBox="0 0 24 24"><path d="M12 2.16c3.2 0 3.58.01 4.85.07 3.25.15 4.77 1.69 4.92 4.92.06 1.27.07 1.65.07 4.85s-.01 3.58-.07 4.85c-.15 3.23-1.66 4.77-4.92 4.92-1.27.06-1.64.07-4.85.07s-3.58-.01-4.85-.07c-3.26-.15-4.77-1.7-4.92-4.92-.06-1.27-.07-1.64-.07-4.85s.01-3.58.07-4.85c.15-3.23 1.66-4.77 4.92-4.92 1.27-.06 1.64-.07 4.85-.07M12 0C8.74 0 8.33.01 7.05.07c-4.27.2-6.78 2.71-6.98 6.98C0 8.33 0 8.74 0 12s.01 3.67.07 4.95c.2 4.27 2.71 6.78 6.98 6.98 1.28.06 1.69.07 4.95.07s3.67-.01 4.95-.07c4.27-.2 6.78-2.71 6.98-6.98.06-1.28.07-1.69.07-4.95s-.01-3.67-.07-4.95c-.2-4.27-2.71-6.78-6.98-6.98C15.67.01 15.26 0 12 0zm0 5.84A6.16 6.16 0 1 0 18.16 12 6.16 6.16 0 0 0 12 5.84zm0 10.16A4 4 0 1 1 16 12 4 4 0 0 1 12 16zm5.23-11.4a1.44 1.44 0 1 1-1.44-1.44 1.44 1.44 0 0 1 1.44 1.44z"/></svg></a>
            <a href="https://wa.me/37253240402"><svg viewBox="0 0 24 24"><path d="M17.47 16.03c-.27-.14-1.63-.8-1.88-.9-.25-.09-.43-.14-.6.14-.18.27-.72.9-.88 1.09-.16.18-.32.2-.59.07-.27-.14-1.16-.43-2.21-1.37-.82-.73-1.37-1.63-1.53-1.9-.16-.27-.02-.42.12-.55.13-.12.27-.32.41-.48.14-.16.19-.27.28-.46.09-.18.05-.34-.02-.48-.07-.14-.6-1.46-.83-1.99-.22-.52-.44-.45-.6-.46h-.5c-.19 0-.5.07-.76.34-.26.27-1.01 1-1.01 2.45 0 1.45 1.04 2.85 1.18 3.04.14.18 2.05 3.19 5.03 4.49 2.52 1.1 3.18 1.17 3.84 1.05.65-.12 2.04-.84 2.33-1.65.29-.8.29-1.49.2-1.64-.08-.13-.27-.2-.55-.33zM12 20.3a8.3 8.3 0 0 1-4.23-1.15l-.3-.18-3.14.83.84-3.07-.2-.31A8.28 8.28 0 0 1 3.7 12a8.3 8.3 0 0 1 8.3-8.3 8.3 8.3 0 0 1 8.3 8.3 8.3 8.3 0 0 1-8.3 8.3zM12 2A10 10 0 1 0 22 12 10 10 0 0 0 12 2z"/></svg></a>
