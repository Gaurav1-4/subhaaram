...
<div class="custom-hero-wrapper">
    ...
    <nav class="custom-nav">
        ...
        <div class="custom-nav-links">
            ...
            <div class="dropdown">
                <a href="#rec2074093803" class="dropbtn">Gallery <span style="font-size: 10px;">▼</span></a>
                <div class="dropdown-content gallery-dropdown-container">
                    <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(110px, 1fr)); gap: 10px;">
                        <a href="#rec2074093803" style="padding: 0 !important; border-bottom: none !important; background: transparent !important;"><img src="07e16d0d-74b9-418b-abdc-01bb09836c15.JPG" style="width:100%; height:110px; object-fit:cover; border-radius:6px; transition: transform 0.2s;" onmouseover="this.style.transform='scale(1.05)'" onmouseout="this.style.transform='scale(1)'"></a>
                        <a href="#rec2074093803" style="padding: 0 !important; border-bottom: none !important; background: transparent !important;"><img src="66f8814b-4316-4a4c-8333-32c4290880f2.JPG" style="width:100%; height:110px; object-fit:cover; border-radius:6px; transition: transform 0.2s;" onmouseover="this.style.transform='scale(1.05)'" onmouseout="this.style.transform='scale(1)'"></a>
                        <a href="#rec2074093803" style="padding: 0 !important; border-bottom: none !important; background: transparent !important;"><img src="97fcb8f3-91a8-4cb4-9949-0ae808e209a8.JPG" style="width:100%; height:110px; object-fit:cover; border-radius:6px; transition: transform 0.2s;" onmouseover="this.style.transform='scale(1.05)'" onmouseout="this.style.transform='scale(1)'"></a>
                        <a href="#rec2074093803" style="padding: 0 !important; border-bottom: none !important; background: transparent !important;"><img src="9ca37a47-9771-46a3-9418-503e99d334c5.JPG" style="width:100%; height:110px; object-fit:cover; border-radius:6px; transition: transform 0.2s;" onmouseover="this.style.transform='scale(1.05)'" onmouseout="this.style.transform='scale(1)'"></a>
                        <a href="#rec2074093803" style="padding: 0 !important; border-bottom: none !important; background: transparent !important;"><img src="ca4bf0f5-9e5d-44b6-844a-e4e077c19737.JPG" style="width:100%; height:110px; object-fit:cover; border-radius:6px; transition: transform 0.2s;" onmouseover="this.style.transform='scale(1.05)'" onmouseout="this.style.transform='scale(1)'"></a>
                        <a href="#rec2074093803" style="padding: 0 !important; border-bottom: none !important; background: transparent !important;"><img src="cdd4345b-ffdc-41d5-83b0-3ec0dae2fdb3.JPG" style="width:100%; height:110px; object-fit:cover; border-radius:6px; transition: transform 0.2s;" onmouseover="this.style.transform='scale(1.05)'" onmouseout="this.style.transform='scale(1)'"></a>
                        <a href="#rec2074093803" style="padding: 0 !important; border-bottom: none !important; background: transparent !important;"><img src="d27e3061-4dfd-4baa-9385-1fc065bbdd30.JPG" style="width:100%; height:110px; object-fit:cover; border-radius:6px; transition: transform 0.2s;" onmouseover="this.style.transform='scale(1.05)'" onmouseout="this.style.transform='scale(1)'"></a>
                    </div>
                </div>
            </div>
